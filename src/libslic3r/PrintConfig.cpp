...
static t_config_enum_values s_keys_map_PrintHostType {
    ...
    {"craftbotplus",    htCraftbotPlus },
    {"craftbotflow",    htCraftbotFlow },
};
...
static t_config_enum_values s_keys_map_GCodeFlavor {
    ...
    { "craftbotplus",   gcfCraftbotPlus },
    { "craftbotflow",   gcfCraftbotFlow }
};
CONFIG_OPTION_ENUM_DEFINE_STATIC_MAPS(GCodeFlavor)

static t_config_enum_values s_keys_map_IdexPrintMode{
    {"normal",          int(IdexPrintMode ::Normal)},
    {"parallel",        int(IdexPrintMode ::Parallel)},
    {"mirror",          int(IdexPrintMode ::Mirror)},
    {"backup",          int(IdexPrintMode ::Backup)}
};
