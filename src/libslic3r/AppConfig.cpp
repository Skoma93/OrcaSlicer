...
static const std::string VERSION_CHECK_URL = "https://check-version.Skoma93.com/latest";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/Skoma93/orcaslicer-profiles/releases/tags";
