    ...
    , p(new priv(this))
{
    ...
    p->custom_config.reset(DynamicPrintConfig::new_from_defaults_keys({
        "gcode_flavor", "printable_area", "bed_exclude_area", "bed_exclude_area_left_mode", "bed_exclude_area_right_mode", "is_idex_printer",
        "bed_exclude_area_mirror_mode", "bed_exclude_area_parallel_mode", "bed_custom_texture", "bed_custom_model", "nozzle_diameter",
