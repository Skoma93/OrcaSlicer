    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(114, 29, 111), StateColor::Pressed), std::pair<wxColour, int>(wxColour(169, 60, 166), StateColor::Hovered),
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0x92278f));
    ...
    m_statictext_finish->SetForegroundColour(wxColour(146, 39, 143));
