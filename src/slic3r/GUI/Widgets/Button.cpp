    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xa93ca6, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0x92278f, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#721d6f", "#a93ca6", "#92278f", "#92278f", "#807e7e", "#262E30", "#262E30", "#6a1868", "#c471c6"};
wxString btn_confirm[10]  = {"#DFDFDF", "#721d6f", "#a93ca6", "#92278f", "#92278f", "#807e7e", "#FEFEFE", "#FEFEFE", "#6a1868", "#c471c6"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#b23b8f", "#df5c94", "#df5c94", "#807e7e", "#262E30", "#FFFFFD", "#6a1868", "#c471c6"};
wxString btn_disabled[10] = {"#DFDFDF", "#DFDFDF", "#DFDFDF", "#DFDFDF", "#DFDFDF", "#807e7e", "#807e7e", "#262E30", "#DFDFDF", "#DFDFDF"};
