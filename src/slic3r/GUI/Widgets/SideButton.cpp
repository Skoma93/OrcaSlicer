    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(114, 0, 137), StateColor::Pressed);
    border_color.append(wxColour(145, 38, 166), StateColor::Hovered);
    border_color.append(0x7D0096, StateColor::Normal);
    ...
    background_color.append(wxColour(114, 0, 137), StateColor::Pressed);
    background_color.append(wxColour(145, 38, 166), StateColor::Hovered);
    background_color.append(0x7D0096, StateColor::Normal);
