    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(114, 29, 111), StateColor::Pressed);
    border_color.append(wxColour(169, 60, 166), StateColor::Hovered);
    border_color.append(0x721d6f, StateColor::Normal);
    ...
    background_color.append(wxColour(114, 29, 111), StateColor::Pressed);
    background_color.append(wxColour(169, 60, 166), StateColor::Hovered);
    background_color.append(0x721d6f, StateColor::Normal);
