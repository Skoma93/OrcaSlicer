...
static std::map<wxColour, wxColour> gDarkColors{
    {"#7D0096", "#560067"}, // rgb(125, 0, 150)    ORCA color
    ...
    {"#9126A6", "#6B0081"}, // rgb(125, 0, 150)    Button Confirm Color hover | ORCA Color Hover
    ...
    {"#F6D5FD", "#3B3B40"}, // rgb(219, 253, 213)  Not Used anymore // Was used for BBS combo boxes etc
    ...
    {"#F8EDFA", "#283232"}, // rgb(229, 240, 238)  Not Used anymore // Was used for BBS Combo / Dropdown focused background color
    ...
    {"#E5D7E8", "#1F2B27"}, // rgb(215, 232, 222)  Not Used anymore // Leftover from BBS
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#DBBFE1", "#38223C"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#EEE5F0", "#283232"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
