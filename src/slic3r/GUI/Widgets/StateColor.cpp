...
static std::map<wxColour, wxColour> gDarkColors{
    {"#a93ca6", "#8c3289"},                         // rgb(146, 39, 143)    ORCA color (purple base + dark)
    {"#7A2ED2", "#7A2ED2"},                         // rgb(122, 46, 210)   purple accent
    {"#FF6F00", "#D15B00"},                         // rgb(255, 111, 0)    Secondary color
    {"#D01B1B", "#BB2A3A"},                         // rgb(208, 27, 27)    Alert color
    ...
    {"#DBFDD5", "#3B3B40"},                         // rgb(219, 253, 213)  Not Used anymore
    ...
    {"#EDFAF2", "#283232"},                         // rgb(229, 240, 238)  Not Used anymore
    {"#323A3C", "#E5E5E6"},                         // rgb(50, 58, 60)     Text color used on search list
    {"#303A3C", "#E5E5E5"},                         // rgb(48, 58, 60)     Object Table > Column header text
    {"#FEFFFF", "#242428"},                         // rgb(254, 255, 255)  Side Tabbar bg
    {"#A6A9AA", "#2D2D29"},                         // rgb(166, 169, 170)  Seperator color
    {"#363636", "#B2B3B5"},                         // rgb(54, 54, 54)     Sidebar > Parameter Label
    {"#F0F0F1", "#333337"},                         // rgb(240, 240, 241)  Disabled element background
    {"#9E9E9E", "#53545A"},                         // rgb(158, 158, 158)  ???
    {"#D7E8DE", "#1F2B27"},                         // rgb(215, 232, 222)  Not Used anymore
    {"#2B3436", "#808080"},                         // rgb(43, 52, 54)     Not Used anymore
    {"#ABABAB", "#ABABAB"}, 
    {"#D9D9D9", "#2D2D32"}, // rgb(217, 217, 217)  Sidebar > Toggle button track color
    {"#DABFE1", "#3C233C"},                         // rgb(191, 225, 222)  Dropdown checked item background (purple)
    {"#EEDFF0", "#322832"},                         // rgb(229, 240, 238)  Combo/Dropdown focused background (purple)
};
