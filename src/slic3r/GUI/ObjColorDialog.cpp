...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(114, 29, 111), StateColor::Pressed),
...
wxBoxSizer* ObjColorDialog::create_btn_sizer(long flags)
{
    ...
    StateColor calc_btn_bg(
        std::pair<wxColour, int>(wxColour(114, 29, 111), StateColor::Pressed),
        std::pair<wxColour, int>(wxColour(169, 60, 166), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Normal)
    );
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(114, 29, 111), StateColor::Pressed), std::pair<wxColour, int>(wxColour(169, 60, 166), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Normal));
