    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(146, 39, 143));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(114, 29, 111), StateColor::Pressed),
            std::pair<wxColour, int>(wxColour(169, 60, 166), StateColor::Hovered),
            std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Normal));
        edit_button->SetBackgroundColour(*wxWHITE);
        edit_button->SetBackgroundColor(btn_bg_green);
        edit_button->SetBorderColor(wxColour(146, 39, 143));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(146, 39, 143));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(146, 39, 143));
