...
static const wxColour TEXT_NORMAL_CLR = wxColour(146, 39, 143);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(114, 29, 111), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(169, 60, 166), StateColor::Hovered), std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(146, 39, 143), StateColor::Enabled));
