...
void MainFrame::update_layout()
{
    ...
    case ESettingsLayout::GCodeViewer:
    {
        ...
        m_plater->set_bed_shape({{0.0, 0.0}, {200.0, 0.0}, {200.0, 200.0}, {0.0, 200.0}}, {}, {}, IdexPrintMode::Normal, {}, {}, 0.0, {}, {}, {}, {}, true);
...
void MainFrame::update_side_button_style()
{
    ...
    StateColor m_btn_bg_enable = StateColor(
        ...
        std::pair<wxColour, int>(wxColour(99, 48, 221), StateColor::Hovered),
